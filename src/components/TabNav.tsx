...
const tabs: { id: TabId; label: string; icon: string }[] = [
  ...
  { id: "travellers", label: "Travellers", icon: "👥" },
];
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`
                flex flex-1 flex-col items-center gap-0.5 py-2.5 px-2
            ...
            >
              ...
              <span className={`text-xs font-semibold ${isActive ? "text-lavender-700" : ""}`}>
                {tab.label}
              </span>
              {isActive && (
                <span
